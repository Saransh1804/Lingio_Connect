  ...
  return (
    ...
    <div className='flex  justify-center   '>
        ...
        <div className='text-white text-3xl p-3 max-[524px]:p-2 mb-6 font-bold'>
            Sign Up to Lingio-Connect
        </div>
        <input className='bg-black text-xl border-2 text-white  rounded-lg border-cyan-950 pr-1 pl-2  py-2' placeholder='Enter full name' type='text' name='fullName' />
        <input className='bg-black p-2 text-xl text-white border-2  rounded-lg border-cyan-950' placeholder='Enter username' type='text' name='userName' />
        ...
        <input className='bg-black p-2 text-xl border-2 text-white  rounded-lg border-cyan-950' placeholder='Confirm password' type='password' name='confirmPassword' />
        <span className='text-white text-xs p-1 mb-2 '>
            Already have an account? Click here to login
        </span>
        <button className='hover:bg-black mt-4 bg-cyan-950 text-white font-bold text-xl p-3 border rounded-lg ' >Sign Up</button>
        <div className="flex items-center justify-center mt-8">
      <div className="border-t border-cyan-950 border-3 w-1/3"></div>
      <div className="px-4 max-[462px]:p-0 text-sm max-[362px]:text-xs text-white">or Sign up with</div>
      <div className="border-t  border-cyan-950 border-3 w-1/3"></div>
     </div>
     <button className='hover:bg-cyan-950 hover:text-white max-[342px]:text-sm   flex justify-center items-center gap-3  bg-white  font-bold text-xl p-3 border rounded-3xl' > <FcGoogle className='text-3xl' />  Sign Up with Google</button>
